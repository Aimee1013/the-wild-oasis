...
function SignupForm() {
  ...
  function submitForm({ fullName, email, password }) {
    ...
    <Form onSubmit={handleSubmit(submitForm)}>
      ...
      <FormRow label="Repeat password" error={errors?.passwordConfirm?.message}>
        <Input
          ...
          id="passwordConfirm"
          disabled={isLoading}
          {...register("passwordConfirm", { required: "This field is required", validate: (value) => value === getValues().password || "Password needs to match" })}
        />
      </FormRow>
